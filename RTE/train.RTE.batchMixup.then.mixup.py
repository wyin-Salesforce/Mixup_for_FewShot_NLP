...
def main():
    ...
    model.load_state_dict(torch.load('/export/home/Dataset/BERT_pretrained_mine/mixup_wenpeng/batchMixup_pretrain_kshot_'+str(args.kshot)+'_dev_acc_seed_'+str(args.seed)+'.pt'))
    if n_gpu > 1:
