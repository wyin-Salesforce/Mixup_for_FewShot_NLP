...
CUDA_VISIBLE_DEVICES=5 python -u train.RTE.mixup.py \
    --task_name rte \
    --do_train \
    --do_lower_case \
    --num_train_epochs $EPOCHSIZE \
...
CUDA_VISIBLE_DEVICES=6 python -u train.RTE.mixup.py \
    --task_name rte \
    --do_train \
    --do_lower_case \
    --num_train_epochs $EPOCHSIZE \
...
CUDA_VISIBLE_DEVICES=7 python -u train.RTE.mixup.py \
    --task_name rte \
    --do_train \
    --do_lower_case \
    --num_train_epochs $EPOCHSIZE \
