...
CUDA_VISIBLE_DEVICES=0 python -u train_CLINC150.v2.py \
    --task_name rte \
    --do_train \
    --do_lower_case \
    --num_train_epochs 50 \
...
CUDA_VISIBLE_DEVICES=1 python -u train_CLINC150.v2.py \
    --task_name rte \
    --do_train \
    --do_lower_case \
    --num_train_epochs 50 \
...
CUDA_VISIBLE_DEVICES=2 python -u train_CLINC150.v2.py \
    --task_name rte \
    --do_train \
    --do_lower_case \
    --num_train_epochs 50 \
...
CUDA_VISIBLE_DEVICES=3 python -u train_CLINC150.v2.py \
    --task_name rte \
    --do_train \
    --do_lower_case \
    --num_train_epochs 50 \
...
CUDA_VISIBLE_DEVICES=4 python -u train_CLINC150.v2.py \
    --task_name rte \
    --do_train \
    --do_lower_case \
    --num_train_epochs 50 \
...
#     --kshot 3 \
#     --use_mixup\
#     --beta_sampling_times 30 > log.seed.42.txt 2>&1 &
#
...
#     --kshot 3 \
#     --use_mixup\
#     --beta_sampling_times 30 > log.seed.16.txt 2>&1 &
#
...
#     --kshot 3 \
#     --use_mixup\
#     --beta_sampling_times 30 > log.seed.32.txt 2>&1 &
#
...
#     --kshot 3 \
#     --use_mixup\
#     --beta_sampling_times 30 > log.seed.64.txt 2>&1 &
#
...
#     --kshot 3 \
#     --use_mixup\
#     --beta_sampling_times 30 > log.seed.128.txt 2>&1 &
