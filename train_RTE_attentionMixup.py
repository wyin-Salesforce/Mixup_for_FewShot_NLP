...
class RobertaForSequenceClassification(nn.Module):
    ...
    def forward(self, input_ids, input_mask, input_seg, labels, eye_tensor, is_train = False):
        '''
        ...
        if is_train:
            ...
            queries = self.query_hidden_layer(hidden_states_single) #(batch, hidden)
            keys = self.key_hidden_layer(hidden_states_single) #(batch, hidden)
