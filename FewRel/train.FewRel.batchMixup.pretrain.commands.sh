...
CUDA_VISIBLE_DEVICES=1 python -u train.FewRel.batchMixup.pretrain.py \
    --task_name rte \
    --do_train \
    --do_lower_case \
    --num_train_epochs $EPOCHSIZE \
...
CUDA_VISIBLE_DEVICES=2 python -u train.FewRel.batchMixup.pretrain.py \
    --task_name rte \
    --do_train \
    --do_lower_case \
    --num_train_epochs $EPOCHSIZE \
...
CUDA_VISIBLE_DEVICES=3 python -u train.FewRel.batchMixup.pretrain.py \
    --task_name rte \
    --do_train \
    --do_lower_case \
    --num_train_epochs $EPOCHSIZE \
